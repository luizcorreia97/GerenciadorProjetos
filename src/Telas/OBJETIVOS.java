...
public class OBJETIVOS extends JFrame {
	...
	ObjetivosDAO Objetivos = new ObjetivosDAO();
	...
	public OBJETIVOS(int id_projeto) {
		addWindowListener(new WindowAdapter() {
			@Override
			public void windowActivated(WindowEvent e) {
				Objetivos.setId_projeto(id_projeto);
				popular_table();
		...
		btn_cadastrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int valida = JOptionPane.showConfirmDialog(null,"Deseja Realmente Cadastrar ''"
						...
						Objetivos.setId_projeto(id_projeto);
						Objetivos.setDescricao(txt_descrição.getText());
						...
						if(valida == JOptionPane.YES_OPTION){
							...
							JOptionPane.showMessageDialog(null, "''"+Objetivos.getDescricao()+"'' Não Foi Cadastrado(a)! =(");
							txt_descrição.setText(null);
							txt_descrição.requestFocus();
						}
			}
		...
		btn_alterar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				int valida = JOptionPane.showConfirmDialog(null,"Deseja Realmente Alterar ''"
						...
						if(valida == JOptionPane.YES_OPTION){
							Objetivos.setId(Integer.parseInt(table.getValueAt(posicao_table, 0).toString()));
							Objetivos.Alterar();
							JOptionPane.showMessageDialog(null, "''"+table.getValueAt(posicao_table, 1).toString()+"'' Alterado(a) Com Sucesso Para ''"+Objetivos.getDescricao()+"'' =)");
							txt_descrição.setText(null);
							txt_descrição.requestFocus();
							popular_table();
						}
	...
	public void popular_table(){
		...
		table.setModel(Objetivos.Listar());
