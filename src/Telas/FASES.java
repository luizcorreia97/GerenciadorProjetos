...
public class FASES extends JFrame {
		...
		btn_cadastrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int valida = JOptionPane.showConfirmDialog(null,"Deseja Realmente Cadastrar "
						...
						Fases.setDescricao(txt_descrição.getText());
				
						if(valida == JOptionPane.YES_OPTION){
							Fases.Cadastrar();
							JOptionPane.showMessageDialog(null, Fases.getDescricao()+" Cadastrado(a) Com Sucesso! =)");
							txt_descrição.setText(null);
							txt_descrição.requestFocus();
							popular_table();
						}
						else {
							JOptionPane.showMessageDialog(null, Fases.getDescricao()+" Não Foi Cadastrado(a)! =(");
							txt_descrição.setText(null);
							txt_descrição.requestFocus();
						}
			}
		...
		btn_alterar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				int valida = JOptionPane.showConfirmDialog(null,"Deseja Realmente Alterar "
						...
						if(valida == JOptionPane.YES_OPTION){
							Fases.setId(Integer.parseInt(table.getValueAt(posicao_table, 0).toString()));
							Fases.Alterar();
							JOptionPane.showMessageDialog(null, table.getValueAt(posicao_table, 1).toString()+" Alterado(a) Com Sucesso Para "+Fases.getDescricao()+" =)");
							txt_descrição.setText(null);
							txt_descrição.requestFocus();
							popular_table();
						}
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				Fases.	setDescricao(txt_descrição.getText());
						...
						if(valida == JOptionPane.YES_OPTION){
							Fases.setId(Integer.parseInt(table.getValueAt(posicao_table, 0).toString()));
							Fases.Excluir();
							JOptionPane.showMessageDialog(null, Fases.getDescricao()+" Excluído(a) Com Sucesso! =)");
							txt_descrição.setText(null);
							txt_descrição.requestFocus();
							popular_table();
						}
	...
	//MÉTODO LISTAR TABELA
	public void popular_table(){
		
		table.setModel(Fases.Listar());
