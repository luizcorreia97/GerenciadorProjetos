...
import Classes.Ciclo_de_VidaDAO;
...
public class CICLOS_DE_VIDA extends JFrame {
	
	Ciclo_de_VidaDAO Ciclo_de_Vida = new Ciclo_de_VidaDAO();
	...
	public CICLOS_DE_VIDA() {
		...
		setTitle("GERENCIAR CICLOS DE VIDA");
		setLocation(450, 150);
		...
		txt_descrição.setBounds(133, 66, 329, 22);
		...
		btn_cadastrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int valida = JOptionPane.showConfirmDialog(null,"Deseja Realmente Cadastrar "
						...
						Ciclo_de_Vida.setDescricao(txt_descrição.getText());
				
						if(valida == JOptionPane.YES_OPTION){
							Ciclo_de_Vida.Cadastrar();
							JOptionPane.showMessageDialog(null, Ciclo_de_Vida.getDescricao()+" Cadastrado(a) Com Sucesso! =)");
							txt_descrição.setText(null);
							txt_descrição.requestFocus();
							popular_table();
						}
						else {
							JOptionPane.showMessageDialog(null, Ciclo_de_Vida.getDescricao()+" Não Foi Cadastrado(a)! =(");
							txt_descrição.setText(null);
							txt_descrição.requestFocus();
						}
			}
		...
		btn_alterar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				Ciclo_de_Vida.setDescricao(txt_descrição.getText());
						...
						if(valida == JOptionPane.YES_OPTION){
							Ciclo_de_Vida.setId(Integer.parseInt(table.getValueAt(posicao_table, 0).toString()));
							Ciclo_de_Vida.Alterar();
							JOptionPane.showMessageDialog(null, table.getValueAt(posicao_table, 1).toString()+" Alterado(a) Com Sucesso Para "+Ciclo_de_Vida.getDescricao()+" =)");
							txt_descrição.setText(null);
							txt_descrição.requestFocus();
							popular_table();
						}
		...
		btn_excluir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				Ciclo_de_Vida.setDescricao(txt_descrição.getText());
						...
						if(valida == JOptionPane.YES_OPTION){
							Ciclo_de_Vida.setId(Integer.parseInt(table.getValueAt(posicao_table, 0).toString()));
							Ciclo_de_Vida.Excluir();
							JOptionPane.showMessageDialog(null, Ciclo_de_Vida.getDescricao()+" Excluído(a) Com Sucesso! =)");
							txt_descrição.setText(null);
							txt_descrição.requestFocus();
							popular_table();
						}
	...
	public void popular_table(){
		...
		table.setModel(Ciclo_de_Vida.Listar());
