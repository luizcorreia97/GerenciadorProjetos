...
public class PREMISSAS extends JFrame {

	PremissasDAO Premissas = new PremissasDAO();
	...
	public PREMISSAS(int id_projeto) {
		addWindowListener(new WindowAdapter() {
			@Override
			public void windowActivated(WindowEvent e) {
				Premissas.setId_projeto(id_projeto);
				popular_table();
		...
		btn_cadastrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int valida = JOptionPane.showConfirmDialog(null,"Deseja Realmente Cadastrar ''"
						...
						Premissas.setId_projeto(id_projeto);
						Premissas.setDescricao(txt_descrição.getText());
						...
						if(valida == JOptionPane.YES_OPTION){
							...
							JOptionPane.showMessageDialog(null, "''"+Premissas.getDescricao()+"'' Não Foi Cadastrado(a)! =(");
							txt_descrição.setText(null);
							txt_descrição.requestFocus();
						}
			}
		...
		btn_alterar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				int valida = JOptionPane.showConfirmDialog(null,"Deseja Realmente Alterar ''"
						...
						if(valida == JOptionPane.YES_OPTION){
							Premissas.setId(Integer.parseInt(table.getValueAt(posicao_table, 0).toString()));
							Premissas.Alterar();
							JOptionPane.showMessageDialog(null, "''"+table.getValueAt(posicao_table, 1).toString()+"'' Alterado(a) Com Sucesso Para ''"+Premissas.getDescricao()+"'' =)");
							txt_descrição.setText(null);
							txt_descrição.requestFocus();
							popular_table();
						}
	...
	public void popular_table(){
		...
		table.setModel(Premissas.Listar());
