...
public class REQUISITOS extends JFrame {
	...
	public REQUISITOS(int id_projeto) {
		...
		txt_descrição.setBounds(127, 99, 545, 92);
		...
		btn_cadastrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int valida = JOptionPane.showConfirmDialog(null,"Deseja Realmente Cadastrar ''"
						...
						Requisitos.setDescrição(txt_descrição.getText());
						...
						if(valida == JOptionPane.YES_OPTION){
							...
							JOptionPane.showMessageDialog(null, "''"+Requisitos.getRF()+"'' Não Foi Cadastrado(a)! =(");
							txt_rf.setText(null);
							txt_descrição.setText(null);
							txt_rf.requestFocus();
						}
