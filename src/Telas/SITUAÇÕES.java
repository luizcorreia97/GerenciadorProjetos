...
public class SITUAÇÕES extends JFrame {

	SituaçõesDAO Situações = new SituaçõesDAO();
		...
		btn_cadastrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int valida = JOptionPane.showConfirmDialog(null,"Deseja Realmente Cadastrar "
						...
						Situações.setDescricao(txt_descrição.getText());
				
						if(valida == JOptionPane.YES_OPTION){
							Situações.Cadastrar();
							JOptionPane.showMessageDialog(null, Situações.getDescricao()+" Cadastrado(a) Com Sucesso! =)");
							txt_descrição.setText(null);
							txt_descrição.requestFocus();
							popular_table();
						}
						else {
							JOptionPane.showMessageDialog(null, Situações.getDescricao()+" Não Foi Cadastrado(a)! =(");
							txt_descrição.setText(null);
							txt_descrição.requestFocus();
						}
			}
		...
		btn_alterar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				int valida = JOptionPane.showConfirmDialog(null,"Deseja Realmente Alterar "
						...
						if(valida == JOptionPane.YES_OPTION){
							Situações.setId(Integer.parseInt(table.getValueAt(posicao_table, 0).toString()));
							Situações.Alterar();
							JOptionPane.showMessageDialog(null, table.getValueAt(posicao_table, 1).toString()+" Alterado(a) Com Sucesso Para "+Situações.getDescricao()+" =)");
							txt_descrição.setText(null);
							txt_descrição.requestFocus();
							popular_table();
						}
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				int valida = JOptionPane.showConfirmDialog(null,"Deseja Realmente Excluir "
						...
						if(valida == JOptionPane.YES_OPTION){
							Situações.setId(Integer.parseInt(table.getValueAt(posicao_table, 0).toString()));
							Situações.Excluir();
							JOptionPane.showMessageDialog(null, Situações.getDescricao()+" Excluído(a) Com Sucesso! =)");
							txt_descrição.setText(null);
							txt_descrição.requestFocus();
							popular_table();
						}
	...
	public void popular_table(){
		...
		table.setModel(Situações.Listar());
